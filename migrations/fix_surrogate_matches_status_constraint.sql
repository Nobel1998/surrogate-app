...
-- Step 1: Drop ALL possible CHECK constraints on status column FIRST
...
-- Step 2: Now update any invalid status values to valid ones (constraints are dropped, so this will work)
