...
export default function ParentInfoPage() {
  ...
  if (error) {
    return (
      <div className="p-6">
        ...
        <Link href={`/cases/${caseId}`} className="mt-4 inline-block text-blue-600 hover:text-blue-800">
          ← Back to Case
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <Link href={`/cases/${caseId}`} className="text-blue-600 hover:text-blue-800">
          ← Back to Case
        </Link>
      </div>
