...
export async function POST(req: Request) {
  ...
  try {
    ...
    const path = `surrogacy-contract/${userId}-${timestamp}-${randomStr}${ext}`;
    ...
    // Insert document for this specific user only (surrogate)
    ...
    console.error('[matches/surrogacy-contract] POST error', err);
