...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Using 'trust_account' as document_type
    ...
    results.push({ user_id: parentId, document_type: 'trust_account' });
    ...
    results.push({ user_id: surrogateId, document_type: 'trust_account' });
