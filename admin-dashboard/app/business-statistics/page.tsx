          ...
          <div className="mb-4">
            ...
            {showSurrogateFilters && (
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 p-4 bg-gray-50 rounded">
                ...
                {/* Pregnancy Test Date Range */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pregnancy Test Date From</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pregnancy Test Date To</label>
                  <input
                    type="date"
