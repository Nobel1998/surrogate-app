        ...
        <div className="bg-white rounded-lg shadow p-4 mb-6">
          ...
          <div className="mb-4">
            ...
            <div>
              ...
              >
                <option value="">All</option>
                <option value="pgs_tested">PGS-tested</option>
          ...
          <div className="mb-4">
            ...
            {showSurrogateFilters && (
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4 p-4 bg-gray-50 rounded">
                ...
                {/* HCG Test Date Range */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">HCG Test Date From</label>
                  <input
                    type="date"
                    value={selectedPregnancyTestDateFrom}
                    onChange={(e) => setSelectedPregnancyTestDateFrom(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">HCG Test Date To</label>
                  <input
                    type="date"
                    value={selectedPregnancyTestDateTo}
                    onChange={(e) => setSelectedPregnancyTestDateTo(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
